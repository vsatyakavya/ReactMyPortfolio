    ...
    return (
        <Container>
            ...
            <Row>
                ...
                <div class="col-sm-10 " style={{boxSizing:"borderBox", padding:"50px"}}>
                    <h1>Contact Information</h1>
                    <p><i class="fa fa-file" style={{ fontSize: "50px", color: "green" }}></i>
                        <a href={resume} target="blank" style={{ color: "white", fontSize: "25px", textAlign:"center" }}> Resume</a></p>

                    <p><i class="fa fa-envelope-square" style={{ fontSize: "55px", color: "red" }}></i>
                        <a href="mailto:satyakavya24@gmail.com" target="blank" style={{ color: "white", fontSize: "25px" }}> Gmail</a></p>
